...
public class ErrorLoggingController {
    ...
    static {
        ...
        window: D:\OJT_projects\logfile\collectserverlog\error.log
        linux: /home/junmokang/scriptBox/serverlog/error.log
        * */
        try {
            errorFileHandler = new FileHandler("D:\\OJT_projects\\logfile\\collectserverlog\\error.log", true);
